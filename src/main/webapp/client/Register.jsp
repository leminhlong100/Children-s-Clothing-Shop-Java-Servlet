					...
					<div class="col-md-12">
						<div class="form-style form-login">
							<form accept-charset="utf-8" action="${register}"
								...
								<input name="FormType" type="hidden" value="customer_register" required/>
								<input name="utf8" type="hidden" value="true" required/><input
									type="hidden" id="Token-c9bce25cd2374351a51134277eb7440f"
									name="Token" required />
								...
								<div class="row">
									...
									<div class="col-md-11">
										<input id="mobile" type="text" value="" name="phoneNumber" required />
									</div>
								</div>
								<div class="row">
									<p style="color: red; display: none;" class="col-md-11"
								...
								<div class="row">
									...
									<div class="col-md-11">
										<input id="pass" type="password" value="" name="password" required/>
									</div>
									<div class="row">
										<p style="color: red; display: none;" class="col-md-11"
											id="errorPass"></p>
								...
								<div class="row">
									...
									<div class="col-md-11">
										<input id="repass" type="password" value="" name="repassword" required/>
									</div>
									<div class="row">
										<p style="color: red; display: none;" class="col-md-11"
											id="errorRepass"></p>
								...
								<div class="row">
									...
									<div class="col-md-11">
										...
										<a href="javascript:void(0)" class="social-login--facebook"><img
											width="129px" height="37px" alt="facebook-login-button"
											src="//bizweb.dktcdn.net/assets/admin/images/login/fb-btn.svg"></a>
										<a href="javascript:void(0)" class="social-login--google"><img
