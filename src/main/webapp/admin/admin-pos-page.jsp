...
<head>
  <title>Pos bán hàng | Quản trị Admin</title>
  <meta charset="utf-8">
...
<header class="app-header">
  ...
  <ul class="app-nav">
    ...
    <!-- User Menu-->
    <li><a class="app-nav__item" href="${pageContext.request.contextPath}/admin-index"><i class='bx bx-log-out bx-rotate-180'></i> </a>
      ...
      <div class="tile">
        ...
        <div class="row">
          ...
          <div class="tile-footer col-md-12">
            ...
            <a class="btn btn-secondary luu-va-in" href="${pageContext.request.contextPath}/admin-index">Quay về</a>
          </div>
        </div>
      </div>
    </div>
