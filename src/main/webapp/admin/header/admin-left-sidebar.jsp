...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a id="admin-products" class="app-menu__item" href="${pageContext.request.contextPath}/admin-products/ProductListController"><i
                class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Quản lý sản phẩm</span></a>
        </li>
        <li><a id="admin-discount" class="app-menu__item" href="${pageContext.request.contextPath}/admin-discount/discount"><i
                class='app-menu__icon bx bxs-discount'></i><span class="app-menu__label">Quản lý mã giảm giá</span></a>
        </li>
        <li><a id="admin-bill" class="app-menu__item" href="${pageContext.request.contextPath}/admin-bill/BillProductListController"><i
                class='app-menu__icon bx bx-task'></i><span
                class="app-menu__label">Quản lý đơn hàng</span></a></li>
        <li><a id="admin-revenue" class="app-menu__item" href="${pageContext.request.contextPath}/admin-products/RevenueShowController"><i
